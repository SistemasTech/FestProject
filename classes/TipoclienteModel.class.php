 ...
 * @package entity
 */
class TipoclienteModel extends Db2PhpEntityBase implements Db2PhpEntityModificationTracking {
	private static $CLASS_NAME='TipoclienteModel';
	 ...
	 * Query by Example.
	 *
	 * Match by attributes of passed example instance and return matched rows as an array of TipoclienteModel instances
	 *
	 * @param PDO $db a PDO Database instance
	 * @param TipoclienteModel $example an example instance defining the conditions. All non-null properties will be considered a constraint, null values will be ignored.
	 * @param boolean $and true if conditions should be and'ed, false if they should be or'ed
	 * @param array $sort array of DSC instances
	 * @return TipoclienteModel[]
	 */
	public static function findByExample(PDO $db,TipoclienteModel $example, $and=true, $sort=null) {
	 ...
	 *
	 * Will return matched rows as an array of TipoclienteModel instances.
	 *
	 * @param PDO $db a PDO Database instance
	...
	/**
	 * Will execute the passed statement and return the result as an array of TipoclienteModel instances
	 *
	...
	/**
	 * returns the result as an array of TipoclienteModel instances without executing the passed statement
	 *
	 * @param PDOStatement $stmt
	 * @return TipoclienteModel[]
	 */
	...
	/**
	 * Execute select query and return matched rows as an array of TipoclienteModel instances.
	 *
	...
	/**
	 * Fetch ClienteModel's which this TipoclienteModel references.
	 ...
	 * @return ClienteModel[]
	 */
	public function fetchClienteModelCollection(PDO $db, $sort=null) {
		$filter=array(ClienteModel::FIELD_CODIGOTIPOCLIENTE=>$this->getCodigoTipoCliente());
		return ClienteModel::findByFilter($db, $filter, true, $sort);
	}
	...
	public function toDOM() {
		return self::hashToDomDocument($this->toHash(), 'TipoclienteModel');
	}

	/**
	 * get single TipoclienteModel instance from a DOMElement
	 *
	...
	/**
	 * get all instances of TipoclienteModel from the passed DOMDocument
	 *
	...
	public static function fromDOMDocument(DOMDocument $doc) {
		$instances=array();
		foreach ($doc->getElementsByTagName('TipoclienteModel') as $node) {
