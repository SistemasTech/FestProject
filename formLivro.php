                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <form role="form" method="POST" action="adicionar/adcionarLivro.php">
                                        <div class="form-group">
                                            <label>Titulo do Livro</label>
                                            <input class="form-control" name="tituloLivro" type="text">
                                        ...
                                        <div class="form-group">
                                            <label>Edição</label>
                                            <input name="edicao" class="form-control" type="text">
                                                <p class="help-block"></p>
                                        </div>
                                        <div class="form-group">
                                            <label>Ano de Lançamento</label>
                                            <input class="form-control" name="anoLancamento" type="text">
                                                <p class="help-block"></p>
                                        </div>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a href="eliminar/eliminarLivro.php?codigoLivro=<?php echo $livros['codigoLivro']; ?>"><i class="fa fa-bomb"></i>Eliminar</a></li>
                                                            <li class="divider"></li>
                                                            <li><a href="formActualizarLivro.php?codigoLivro=<?php echo $livros['codigoLivro']; ?>"><i class="glyphicon glyphicon-search"></i>Actualizar</a></li>
